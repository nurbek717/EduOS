...
const { list, create, update, remove } = require("./teacher.controller");
...
const { enforceActiveSubscription } = require("../../middleware/limits.middleware");

const router = express.Router();

router.get("/", tenantAuthRequired, requireRoles(...STAFF_ROLES), list);
router.post("/", tenantAuthRequired, requireRoles(...TENANT_ADMIN_ROLES), enforceActiveSubscription, create);
